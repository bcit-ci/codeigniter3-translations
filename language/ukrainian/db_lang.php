...
$lang['db_unsuported_feature'] = 'Непідтримувана особливість платформи бази даних, яку Ви використовуєте.';
$lang['db_unsuported_compression'] = 'Формат стискання файлів, який Ви вибрали, не підтримується Вашим сервером.';
