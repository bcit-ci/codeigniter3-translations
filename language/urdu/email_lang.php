...
$lang['email_no_recipients']		= 'مندرجہ ذیل کا  وصول کنندگان میں شامل ہونا لازمی ہے: To, Cc, or Bcc';
...
$lang['email_no_smtp_unpw']		= 'غلطی: آپ کو ایک SMTP کے صارف کا نام اور پاس ورڈ فراہم کرنا ہوگا.';
$lang['email_failed_smtp_login']	= 'AUTH LOGIN کمانڈ بھیجنے میں ناکام. خرابی ہے: %s';
$lang['email_smtp_auth_un']		= 'یوزرنیم کی تصدیق میں ناکام. خرابی ہے: %s';
$lang['email_smtp_auth_pw']		= 'پاس ورڈ کی تصدیق میں ناکام. خرابی ہے: %s';
$lang['email_smtp_data_failure']	= 'ڈیٹا بھیجنا ممکن نہیں ہے: %s';
