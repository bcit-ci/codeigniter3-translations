...
$lang['db_unable_to_select'] = 'Het lukt niet om de database te benaderen: %s';
$lang['db_unable_to_create'] = 'Het lukt niet om de database aan te maken: %s';
...
$lang['db_filepath_error'] = 'Kan niet schrijven naar het genoemde bestand.';
$lang['db_invalid_cache_path'] = 'Kan niet schrijven naar dit cachebestand, en onduidelijk of dit het juiste bestand is.';
$lang['db_table_name_required'] = 'Voor deze actie zou is de naam van de tabel verplicht.';
$lang['db_column_name_required'] = 'Voor deze actieis de kolomnaam verplicht.';
$lang['db_column_definition_required'] = 'Voor deze actie is het opgeven van een kolomdefinitie verplicht.';
$lang['db_unable_to_set_charset'] = 'Kan de karakterset voor de clientverbinding niet instellen: %s';
